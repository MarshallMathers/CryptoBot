...
def handle_data(context, data):
    ...
    close = data.history(context.asset, 'close', bar_count=50, frequency=context.CANDLE_SIZE)
    low = data.history(context.asset, 'low', bar_count=50, frequency=context.CANDLE_SIZE)
    high = data.history(context.asset, 'high', bar_count=50, frequency=context.CANDLE_SIZE)
    volume = data.history(context.asset, 'volume', bar_count=50, frequency=context.CANDLE_SIZE)
...
if __name__ == '__main__':
    ...
    run_algorithm(
        ...
        quote_currency='usd',
        start=pd.to_datetime('2017-02-01', utc=True),
        end=pd.to_datetime('2017-06-12', utc=True),
    )
